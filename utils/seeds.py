from models import User, Parametro, Alarme, Sensor
...
def generate_seeds(db:SQLAlchemy):
    ...
    user1 = User(email = "admin@pucpr.br", username = "admin", password = generate_password_hash("admin"), permission = "admin")
    user2 = User(email = "gabriel@pucpr.br", username = "gabriel", password = generate_password_hash("gabriel"), permission = "default")
    user2 = User(email = "asd@asd", username = "asd", password = generate_password_hash("asd"), permission = "default")
